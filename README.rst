...
+=========+============+==========================================================================================================+
|         |            | | Use AdminSite.has_permission instead of staff_member_required. Contributed by #j-osephlong             |
|         |            | | Make it possible to reorder filters.                                                                   |
+---------+------------+----------------------------------------------------------------------------------------------------------+
| 4.2.11  | 2026-02-23 | | Add support for Python 3.13 and 3.14 and Django 5.1, 5.2 and 6.0                                       |
