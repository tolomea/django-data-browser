...
class TestDateTimeType(ParseHelpers):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("2018-21-12", None, "Month must be in 1..12(, not 21)?: 2018-21-12"),
            ("2018-11-12", dt(2018, 11, 12), None),
            ("2018-21-22", None, "Month must be in 1..12(, not 21)?: 2018-21-22"),
            ("2018-3-2", dt(2018, 3, 2), None),
            ("20181111", dt(2018, 11, 11), None),
            ("20181122", dt(2018, 11, 22), None),
            ("20182112", None, "Month must be in 1..12(, not 21)?: 20182112"),
            ("20181112", dt(2018, 11, 12), None),
            ("20182122", None, "Month must be in 1..12(, not 21)?: 20182122"),
